                ...
                @if (isset($rent))
                        ...
                        <div style="display: flex; align-items: center; margin-bottom: 15px;">
                            <div style="margin-right: 20px;">
                                ...
                                <input type="text" id="start_date" name="start_date"
                                    class="form-input flatpickr-input" placeholder="Pilih Tanggal Mulai" required
                            ...
                            <div>
                                ...
                                <input type="text" id="start_time" name="start_time"
                                    class="form-input flatpickr-input" placeholder="Pilih Jam Mulai" required
                                    style="display: block; margin-top: 5px;">
                            </div>
                        </div>
                        <div style="display: flex; align-items: center; margin-bottom: 15px;">
                    ...
                    <div class="mb-3">
                        ...
                        <div style="display: none" id="kendaraaanSection">
                            ...
                            <div class="mb-3">
                                <label for="sppd" class="form-label">Pembebanan Dana SPPD ke Pihak Biro
                                    Umum:</label>
                                <div>
                        ...
                        <div class="mb-3">
                            ...
                            <br>
                            <a href="#" id="existingSuratLink" target="_blank" style="display: none;">Lihat
                                Surat
                                Sebelumnya</a>
